...
$$\newline Z_{small}=\left(\frac{L_{small}}{L_{big}}\right)^{3N}\cdot Z_{big}=\left(\frac{V_{small}}{L_{big}}\right)^N\cdot Z_{big}\doteq\alpha \Rightarrow$$
$$\alpha=(V_{small}/L_{big})^N$$
